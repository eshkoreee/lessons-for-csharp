...
using lesson81;
namespace BenchmarkForLesson81
{
    [MemoryDiagnoser]
    ...
    public class Benchark_3
    {
        ...
        {
            var x = myClass.MyProperty1 + myClass.MyProperty2;
        }
        private void Bar(MyStruct myStruct )
        {
            var x = myStruct.MyProperty1 + myStruct.MyProperty2;
        }
        [Benchmark]
        public void StructTest()
        {
